...
public class ContentController {
	...
	public Iterable<ContentDTO> getEmployee(@PathVariable("ctId") int ctId, Pageable pageable){
		List<ContentDTO> contentDTOs=new ArrayList<>();
		Iterable<Content> contents= contentService.getContentByCT(ctId,pageable);
